...
// What used to stand here: TestGetBoardMetadata, for an endpoint gated on a
// licence this product does not have — it answered "appropriate license
// required" every time, and the page never called it.
