...
--   id: Widened from the 26 the ladder declared, and the one place this schema
...
--     attachment id was truncated by one. UUIDv7 needs 36, which is what
--     every other id column already holds.
CREATE TABLE `{{.prefix}}file_info` (`id` varchar(36) NOT NULL, `create_at` bigint NOT NULL, `delete_at` bigint NULL, `name` text NOT NULL, `extension` varchar(50) NOT NULL, `size` bigint NOT NULL, `archived` bool NULL, `path` varchar(512) NULL) CHARSET utf8mb4 COLLATE utf8mb4_general_ci;
...
--     attachment id was truncated by one. UUIDv7 needs 36, which is what
--     every other id column already holds.
CREATE TABLE "{{.prefix}}file_info" ("id" character varying(36) NOT NULL, "create_at" bigint NOT NULL, "delete_at" bigint NULL, "name" text NOT NULL, "extension" character varying(50) NOT NULL, "size" bigint NOT NULL, "archived" boolean NULL, "path" character varying(512) NULL);
