...
**Решение: ничего специально не делать — они уйдут вместе с переводом времени
на `time.Time`** (`docs/deferred.md`, «Одна база: хвосты плана»). Это
единственная группа, где работа по диалектам и работа по типам — одна работа.
...
не миграция; `docs/deferred.md` («Одна база: хвосты плана») называет её и
откладывает. Одна ветка на весь
